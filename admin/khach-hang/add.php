<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header text-center bg-info text-white text-uppercase">Thêm mới khách hàng</div>
            <div class="card-body">
                <form action="index.php" method="POST" enctype="multipart/form-data" id="admin_add_kh">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="form-control">
                                ...
                                <label class="radio-inline">
                                    <input type="radio" value="1" name="vai_tro" checked>Quản trị
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 text-center mt-3">
                        <input type="reset" value="Nhập lại" class="btn btn-info mr-3">
