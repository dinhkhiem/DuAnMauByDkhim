<nav class="navbar navbar-md navbar-expand-lg navbar-dark p-1">
    <div class="container">
        <a class="navbar-brand" href="<?= $SITE_URL ?>/trang-chinh/index.php">
            <img class="img-fluid logo" src="/content/images/2.png" alt="logo">
        </a>
        ...
        <div class="collapse navbar-collapse justify-content-center" id="navbarsExampleDefault">
            <ul class="navbar-nav m-auto nav">
                ...
                <li class="nav-item">
                    <a class="nav-link text-black" href="<?= $SITE_URL ?>/trang-chinh/index.php?hoi-dap">Liên Hệ</a>
                </li>
            </ul>
                ...
                <div class="input-group input-group-sm">
                    <form action="" method="POST">
                        ...
                        <div class="input-group-append">
                            <button type="submit" name="" class="btn bg-info btn-number btn-custom">
            ...
            <div class="widgets-wrap float-md-right ml-4">
                ...
                <div class="widget-header  mr-3">
                    <a href="<?= $SITE_URL . "/cart/list-cart.php" ?>" class="icon icon-sm rounded-circle border"><i
                            class="fa fa-shopping-cart info-color"></i></a>
