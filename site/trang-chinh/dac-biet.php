<div class="container mt-3">
    <div class="row">
        <div class="col-sm">
            <div class="card">
                <div class="card-header bg-danger text-white text-uppercase text-center">
                   <marquee> Sale Sập Sàn Tháng 10 </marquee>
                </div>
                <div class="card-body">
                    <div class="row">
                                ...
                                <div class="card-body p-0 pt-2 px-2">
                                    ...
                                    <div class="product-price">
                                        <div class="col d-flex justify-content-center align-items-center">
                                            <del class="d-block fz-14"><?= number_format($don_gia ) ?>đ </del>
