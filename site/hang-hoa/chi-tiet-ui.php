...
<div class="container">
                ...
                <div class="card-body text-center">
                    ...
                    <div class="product-price">
                        <div class="col d-flex justify-content-center align-items-center">
                            <del class="d-block"><?= number_format($don_gia) ?>đ</del>
                    ...
                    <form method="post" action="<?= $SITE_URL . "/cart/add-cart.php?id=" . $item['ma_hh'] ?>">
                    ...
                    <div class="product_rassurance">
                        <ul class="list-inline">
                            ...
                            <li class="list-inline-item"><i class="fa fa-phone fa-2x"></i><br />0946046053
                            </li>
                        </ul>
                    </div>
  ...
  <div class="card-header text-black"><i class="fa fa-align-justify"></i>
    Mô tả sản phẩm
  </div>
  <div class="card-body">
...
<section class="same-product mt-5">
    <h3 class="same-product-title text-center">Sản phẩm khác</h3>
