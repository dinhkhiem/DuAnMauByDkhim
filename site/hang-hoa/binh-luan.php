<div class="col-12" id="reviews">
    <div class="card border-light mb-3">
        <div class="card-header  text-black  "><i class="fa fa-comment"></i> Đánh giá
        </div>
        <div class="card-body">
        ...
        if (!isset($_SESSION['user'])) {
            echo '<h5 class="text-center"><i class="text-warning">Vui lòng đăng nhập để bình luận về sản phẩm này!</i></h5>';
        } else {
        ...
        <div class="comment-box text-center">
            ...
            <form action="" method="POST">
                ...
                <div class="text-center mt-4">
                    <button type="submit" class="btn btn-info send px-5">Đăng bình luận 
                    </button>
                </div>
            </form>
        </div>
