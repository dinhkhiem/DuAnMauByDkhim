                 ...
                 <?php foreach ($hh_cung_loai as $hh_cl) :
                    ...
                    ?>
                     <div class="product-card">
                         ...
                         <a class="product-thumb" href="<?= $SITE_URL . '/hang-hoa/chi-tiet.php?ma_hh=' . $hh_cl['ma_hh'] ?>" data-abc="true"><img class="product-img" src="<?= $UPLOAD_URL . "/products/" . $hh_cl['hinh'] ?>">
                         </a>
                         <div class="card-body p-0 pt-3">
                             ...
                             <div class="product-price">
                                 <div class="col d-flex justify-content-center align-items-center">
                                     <del class="d-block fz-14"><?= number_format($hh_cl['don_gia']) ?>đ</del>
                                     <p class="text-danger font-weight-bold fz-20 d-block ml-3 mb-0">
                                         <?= number_format($hh_cl['don_gia'] - $hh_cl['giam_gia']) ?>đ</p>
                                 </div>
                             </div>
                             <div class="product-buttons">
                                 <a href="<?= $SITE_URL . "/cart/add-cart.php?id=" . $hh_cl['ma_hh'] ?>" class="btn btn-outline-primary btn-sm">Add to cart</a>
                             </div>
                         </div>
                     </div>
                 <?php endforeach; ?>
